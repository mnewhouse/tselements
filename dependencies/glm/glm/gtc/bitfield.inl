...
namespace detail
{
	...
	GLM_FUNC_QUALIFIER glm::uint32 bitfieldInterleave(glm::uint8 x, glm::uint8 y, glm::uint8 z)
	{
		...
		REG1 = ((REG1 << 16) | REG1) & static_cast<glm::uint32>(0xFF0000FF);
		REG2 = ((REG2 << 16) | REG2) & static_cast<glm::uint32>(0xFF0000FF);
		REG3 = ((REG3 << 16) | REG3) & static_cast<glm::uint32>(0xFF0000FF);

		REG1 = ((REG1 <<  8) | REG1) & static_cast<glm::uint32>(0x0F00F00F);
		REG2 = ((REG2 <<  8) | REG2) & static_cast<glm::uint32>(0x0F00F00F);
		REG3 = ((REG3 <<  8) | REG3) & static_cast<glm::uint32>(0x0F00F00F);

		REG1 = ((REG1 <<  4) | REG1) & static_cast<glm::uint32>(0xC30C30C3);
		REG2 = ((REG2 <<  4) | REG2) & static_cast<glm::uint32>(0xC30C30C3);
		REG3 = ((REG3 <<  4) | REG3) & static_cast<glm::uint32>(0xC30C30C3);

		REG1 = ((REG1 <<  2) | REG1) & static_cast<glm::uint32>(0x49249249);
		REG2 = ((REG2 <<  2) | REG2) & static_cast<glm::uint32>(0x49249249);
		REG3 = ((REG3 <<  2) | REG3) & static_cast<glm::uint32>(0x49249249);
	...
	GLM_FUNC_QUALIFIER glm::uint32 bitfieldInterleave(glm::uint8 x, glm::uint8 y, glm::uint8 z, glm::uint8 w)
	{
		...
		REG1 = ((REG1 << 12) | REG1) & static_cast<glm::uint32>(0x000F000F);
		REG2 = ((REG2 << 12) | REG2) & static_cast<glm::uint32>(0x000F000F);
		REG3 = ((REG3 << 12) | REG3) & static_cast<glm::uint32>(0x000F000F);
		REG4 = ((REG4 << 12) | REG4) & static_cast<glm::uint32>(0x000F000F);

		REG1 = ((REG1 <<  6) | REG1) & static_cast<glm::uint32>(0x03030303);
		REG2 = ((REG2 <<  6) | REG2) & static_cast<glm::uint32>(0x03030303);
		REG3 = ((REG3 <<  6) | REG3) & static_cast<glm::uint32>(0x03030303);
		REG4 = ((REG4 <<  6) | REG4) & static_cast<glm::uint32>(0x03030303);

		REG1 = ((REG1 <<  3) | REG1) & static_cast<glm::uint32>(0x11111111);
		REG2 = ((REG2 <<  3) | REG2) & static_cast<glm::uint32>(0x11111111);
		REG3 = ((REG3 <<  3) | REG3) & static_cast<glm::uint32>(0x11111111);
		REG4 = ((REG4 <<  3) | REG4) & static_cast<glm::uint32>(0x11111111);
